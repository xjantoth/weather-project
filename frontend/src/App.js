...
export class App extends Component {
    ...
    fetchAllData = () => {
        axios.get('/api/v1/data').then(res => this.setState({data: res.data}))
    };

    fetchDaysData = () => {
        axios.get('/api/v1/data/days').then(res => this.setState({special: res.data}))
    };
    ...
    fetchRangeData = () => { // console.log(dateFormat(this.state.startDate, "yyyy-MM-dd'T'HH:mm:ss"))
        ...
        axios.post(`/api/v1/data/select`, null, {
            params: {
